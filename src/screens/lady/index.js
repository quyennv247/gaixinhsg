...
class LadyScreen extends React.Component {
    constructor(props){
        super(props);
    ...
    getData = () => {
        ladyService.getLadys(this.state.pageIndex, this.state.pageSize).then((response) => {
    ...
    handleClickItem(id){
        this.props.navigation.navigate('Lady-Detail', {
            id: id
        });
    }
